...
\section{Perfil}{
    Ingeniero recién egresado con bases de muchas ramas de la informática y dirección de proyectos. Gran capacidad de aprender tecnologías de desarrollo de software, base de datos y soporte técnico informático. Especializado en \textbf{Frontend}, experiencia de usuario \textbf{(UX)} y manejo de base de datos \textbf{SQL y NoSQL}.
}
...
\section{Experiencia Profesional}{
    \customcventry
        ...
        {{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
            ...
            \item Diseño y desarrollo de web UI aplicando Diseño centrado en el usuario aplicando 4 iteraciones.
