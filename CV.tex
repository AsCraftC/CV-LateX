...
\section{Professional Experience}{
    \customcventry
        ...
        {{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
                \item Frontend project requirements gathering an a project focusing frontend needs.
                ...
                \item Backend integration, using API REST and server deployment via Docker.
            \end{itemize}
        }
    }
