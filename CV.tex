...
\section{Experiencia Profesional}{
    \customcventry
        ...
        {{\begin{itemize}[leftmargin=0.6cm, noitemsep, label={\textbullet}]
            \item Configuración y/o reparación de equipos institucionales para uso de funcionarios aplicando UX y simplificación de tareas cotidianas.
            \item Configuración de servicios, software y redes de oficinas, enfocado en la comodidad de los funcionarios y simplicidad.
            \item Implementación de estrategias de respuesta ágil para la solución inmediata de problemas en el lugar de operación.
            \item Manejo a fondo de administración, configuración y reparación de Sistemas Operativos Windows.
        \end{itemize}}
    }
    ...
    \customcventry
        ...
        {{\begin{itemize}[leftmargin=0.6cm, noitemsep, label={\textbullet}]
            ...
            \item Integración a backend, mediante llamadas a la API y despliegue en servidor utilizando Docker.
        \end{itemize}}
    }
