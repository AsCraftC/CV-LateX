...
\begin{center}
    ...
    \\
        ...
        % \faInstagram\enspace 
        % \href{https://www.instagram.com/ascraft__/}{\underline{instagram.com/ascraft\_\_}}
    \end{tabular}
\end{center}
...
\customcventry
    ...
    {{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
            ...
            \item Diseño y desarrollo de web UI aplicando Diseño centrado en el usuario alrededor de 4 iteraciones.
